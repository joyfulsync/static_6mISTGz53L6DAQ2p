...
var Htmls = {
    getReviewUrl: function (game_type, number, func){
        var url;
        if (game_type == 1 || game_type == 2 || game_type == 3) {
            url = '/review_bull.html' + '?type=' + game_type + '&num=' + number + '&v=' + (new Date().getTime());
        } else if (game_type == 4) {
            if (func && func == 'xp') {
                url = '/review_flowerxp.html' + '?type=' + game_type + '&num=' + number + '&v=' + (new Date().getTime());
            }else{
    ...
    getRoomUrl: function (game_type, max_count, room_number, func){
        ...
        if (game_type == 1 || game_type == 2 || game_type == 3) {
            ...
            if (func && func == 'n') {
                ...
                if (max_count == 6) {
                    url = "/bull6.html?i=" + room_number;
                } else if (max_count == 9) {
                    url = "/bull9.html?i=" + room_number;
                } else if (max_count == 12) {
                    url = "/bull12.html?i=" + room_number;
                } else {
                    url = "/bull6.html?i=" + room_number;
                }
                ...
                if(max_count == 6){
                    url = "/bbull6.1.html?i=" + room_number;
                }else if(max_count == 10){
                    url = "/bbull10.1.html?i=" + room_number;
                }else if(max_count == 13){
                    url = "/bbull13.1.html?i=" + room_number;
                }else if(max_count == 15){
                    url = "/bbull15.1.html?i=" + room_number;
                }else if(max_count == 17){
                    url = "/bbull17.1.html?i=" + room_number;
                }else if(max_count == 19){
                    url = "/bbull19.1.html?i=" + room_number;
                }else if(max_count == 21){
                    url = "/bbull21.1.html?i=" + room_number;
                }else if(max_count == 23){
                    url = "/bbull23.1.html?i=" + room_number;
                }else if(max_count == 9){
                    url = "/bull9.html?i=" + room_number;
                }else if(max_count == 12){
                    url = "/bull12.html?i=" + room_number;
            ...
            if (func && func == 'xp') {
                url = "/flowerxp.html?i=" + room_number;
            } else {
                if(max_count == 6){
                    url = "/flower6_1.html?i=" + room_number;
                }else if(max_count == 9){
                    url = "/flower9_1.html?i=" + room_number;
                }else if(max_count == 12){
            ...
            if(max_count == 6){
                ...
                url = "/sangong12.html?i=" + room_number;
            }else if(max_count == 13){
            ...
            url = "/laibull.html?i=" + room_number;
    ...
    getPackageUrl:function(num){
        if(num==1){
            return  '/package.html'
        }else if(num==2){
            return "/packageDetail.html"
        }else if(num==3){
            return '/packageRecord.html?wid=123'
        }else if(num==4){
            return '/club_invite.html'
        }else if(num==5){
            return '/site/test.html'
        }
    },
    goToError:function (){
        return '/404.html'
