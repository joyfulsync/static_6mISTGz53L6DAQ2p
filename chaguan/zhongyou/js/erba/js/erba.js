...
var ps = {
    ...
    g: function (type) {
		...
		pc: function (type) {
			return '12345678887654321';
		}
};

var decodeMsg = function (data) {
    var res = data;
    var key = C.enc.Utf8.parse(ps.pc(1));
    var ivv = C.enc.Utf8.parse(ps.pc());
...
var audioModule = {
    ...
    loadAllAudioFile: function () {
        ...
        this.loadAudioFile(this.audioUrl + 'fiesc/audio/bull6/background3.mp3', "backMusic");
