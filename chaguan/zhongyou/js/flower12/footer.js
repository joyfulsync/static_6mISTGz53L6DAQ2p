...
<script type="text/javascript" src="<?php echo $file_url;?>files/js/velocity.js"></script>
...
<script type="text/javascript" src="<?php echo $file_url;?>files/js/flower_daoyou8.js?v=1"></script>

<script type="text/javascript" src="<?php echo $file_url;?>files/js/qrcode.js?v=12"></script>

<script type="text/javascript" src="<?php echo $file_url;?>files/js/giftFunc_dy.js?v=bs221"></script>
<script type="text/javascript" src="<?php echo $file_url;?>files/js/gitView_daoyou.js?v=1s2323"></script>
<script type="text/javascript" src="<?php echo $file_url;?>files/js/clipboard.min.js"></script>
<script type="text/javascript" src="<?php echo $file_url;?>files/js/fuzhi_xl.js?v=2021809172"></script>
