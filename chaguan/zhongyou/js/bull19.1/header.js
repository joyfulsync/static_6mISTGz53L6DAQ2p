...
/*
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $file_url;?>fiesc/css/bull19_daoyou_v1.css?v=2Xs0201">
...
var css = [
    ...
    "fiesc/css/bull19_daoyou_v1.css?v=2Xs020",
...
document.write("<script language=javascript src='../js/bull19.1/style.js'></script>");
//：13人拼十(房间号:<?php echo $room_number;?>)
document.title = data.platfrom_name+"：19人拼十(房间号:"+data.room_number+")"
