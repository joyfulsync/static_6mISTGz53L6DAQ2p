...
/*
 <link rel="stylesheet" type="text/css" href="<?php echo $file_url;?>files/css/flower6_daoyou_v1.css?v=12s111">
...
var css = [
    ...
    "files/css/alert.css",
    "files/css/flower9_daoyou_v1.css?v=12s111"
]
...
document.write("<script language=javascript src='../js/flower9/style.js'></script>");
//：13人拼十(房间号:<?php echo $room_number;?>)
document.title = data.platfrom_name+"："+ data.max_count +"人拼三(房间号:"+ data.room_number+")"
