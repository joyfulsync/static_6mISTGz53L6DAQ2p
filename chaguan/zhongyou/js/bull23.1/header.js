...
var css = [
    ...
    "fiesc/css/bull23.1.css?v=2Xs020",
...
document.write("<script language=javascript src='../js/bull23.1/style.js'></script>");
// document.write("<script language=javascript src='../js/bull23.1/bull23.1_css.js'></script>");
//：13人拼十(房间号:<?php echo $room_number;?>)
document.title = data.platfrom_name+"：23人拼十(房间号:"+data.room_number+")"
