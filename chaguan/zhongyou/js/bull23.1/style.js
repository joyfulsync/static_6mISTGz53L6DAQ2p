var header_css = `
    <style>
        ...
        .window-masks .border-opacity-thirteen {
            position: absolute;
            left: 50%;
            top: 50%;
            -webkit-transform: translate(-50%, -50%);
            ...
            -moz-border-radius: .076rem;
            border-radius: .076rem;
            background-color: rgba(57, 81, 130, 1);
            padding: .0720rem .108rem;
        }

        .window-masks.return-index .border-opacity-thirteen .main {
            display: -webkit-flex;
            display: flex;
            -webkit-justify-content: center;
            justify-content: center;
            ...
            margin: 0;
            padding: .0960rem;
            color: rgba(18, 63, 100, 0.7);
            font-size: .2304rem;
            text-align: justify;
        }

        .window-masks.return-index .border-opacity-thirteen .container {
            border: none;
            background-color: #8ad5e4;
            -webkit-border-radius: .0480rem;
            -moz-border-radius: .0480rem;
            border-radius: .0480rem;
        }

        .window-masks.return-index .border-opacity-thirteen .container .button {
            position: relative;
            text-align: center;
            margin-bottom: 0;
            margin-top: .16rem;
        ...
        .window-masks.return-index .border-opacity-thirteen .container .sure, .window-masks.return-index .border-opacity-thirteen .container .cancel {
            display: inline-block;
            width: 1.0272rem;
            height: .3696rem;
            margin: 0 .086rem;
        ...
        .window-masks.return-index .border-opacity-thirteen .container .sure {
            background: url(`+data.file_url+`fiesc/images/newgame/return-index-btn.png) no-repeat;
            background-size: 100% 100%;
        }

        .window-masks.return-index .border-opacity-thirteen .container .cancel {
            background: url(`+data.file_url+`fiesc/images/newgame/cancel.png) no-repeat;
            background-size: 100% 100%;
        }
        ...
        @-webkit-keyframes rotate_load {
            ...
            74% {
                ...
                -moz-transform: rotateY(630deg);
                -ms-transform: rotateY(630deg);
                -o-transform: rotateY(630deg);
            ...
            100% {
                ...
                -moz-transform: rotateY(810deg);
                -ms-transform: rotateY(810deg);
                -o-transform: rotateY(810deg);
        ...
        .auto-ready6 img, .auto-ready10 img{
            width: 100%;
        }
        .auto-ready13,.auto-ready15,.auto-ready17,.auto-ready19,.auto-ready21,.auto-ready23{
            position: absolute;
            bottom: 0.75vh;
            width: 4.5vh;
            height: 4.5vh;
        ...
        .auto-ready13 img, .auto-ready15 img, .auto-ready17 img, .auto-ready19 img, .auto-ready21 img ,.auto-ready23 img{
            width: 100%;
        }
        #dialog{
            position: fixed;
        ...
        .audioRoom-pj .mainPart .createCommit {
            ...
            bottom: -7vh;
            text-align: center;
            background: url("`+data.file_url+`fiesc/images/common/button2.png");
            background-size: 100%;
            color: #fff;
        }
