        ...
        if (globalData.scoreInfo) {
            ...
            for (var i = 0; i < globalData.scoreInfo.player_array.length; i++) {
                ...
                for (var j = 0; j < item.player_cards.length; j++) {
                    ...
                    var cards = value.card_array.concat();
                    if (score > 0) {
                        score = '+' + score;
                    }
                    detailArray.push({
                        ...
                        "score": score,
                        "cards": cards ,
                        "combo_point1":value.combo_point1,
                        "combo_point2":value.combo_point2,
                        "card_type_str1":value.card_type_str1,
                        "card_type_str2":value.card_type_str2,
