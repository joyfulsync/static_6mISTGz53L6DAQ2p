var httpModule = {
    ...
    loadMoreScoreList: function (type) {
        ...
        Vue.http.post(request_url + 'game/scoreList', data,{emulateJSON:true}).then(function(response) {
            ...
            if (bodyData.result == 0) {
                ...
                for (var i = 0; i < bodyData.data.length;i++) {
                    ...
                    appData.gameScoreList.push({"number":item.room_number,"time":item.time,"score":item.score,"game_type":item.game_type});
                }
