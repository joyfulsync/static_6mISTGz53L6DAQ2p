...
var css = [
    "files/css/paijiuD8_daoyou_v1.css?v=s11",
...
document.write("<script language=javascript src='../js/dpj8/style.js'></script>");
//：13人拼十(房间号:<?php echo $room_number;?>)
document.title = data.platfrom_name+"：8人大天九(房间号:"+data.room_number+")"
