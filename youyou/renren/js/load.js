...
var Htmls = {
    ...
    getRoomUrl: function (game_type, max_count, room_number, func){
        ...
        if (game_type == 1 || game_type == 2 || game_type == 3 || game_type ==34) {
            ...
            if(func&& func == 'n'){
                if (max_count == 6) {
                    url = "/bull6_1.html?i=" + room_number;
                } else if (max_count == 9) {
                    url = "/bull9.html?i=" + room_number;
                }else if (max_count == 10) {
                    url = "/bull10_1.html?i=" + room_number;
            ...
            if(func && func == 'xp'){
                ...
                if(max_count == 6){
                    url = "/flower6.1.html?i=" + room_number;
                }else if(max_count == 9){
                    url = "/flower9.html?i=" + room_number;
                }else if(max_count == 12){
                    url = "/flower12.1.html?i=" + room_number;
                }else if(max_count == 13){
            ...
            url = "/dcx_1.html?i=" + room_number;
        } else if (game_type == 14) {
            if(max_count==9){
                url = "/laibull9.html?i=" + room_number;
            }else if(max_count==12){
                url = "/laibull12.html?i=" + room_number;
            }else{
                url = "/laibull9.html?i=" + room_number;
            }
...
//     // 修改浏览器title
//     var new_userName = "";
//     var old_userNname = userData.nickname;
